...
export default function ImportTeacher() {
  ...
  const [result, setResult] = useState(null); // chứa dữ liệu trả về từ API
  ...
  return (
    <div className="max-w-3xl mx-auto mt-10 p-6 bg-gray-900 text-white rounded-2xl shadow-lg border border-gray-700">
                ...
                <table className="w-full text-sm border-collapse">
                  <thead>
                    <tr className="text-gray-400 border-b border-gray-700">
                      ...
                      <th className="text-left p-2">Giảng viên</th>
                  ...
                  <tbody>
                    {result.errors.map((err, idx) => (
                      ...
                      >
                        ...
                        <td className="p-2">{err.teacher_id || "Không rõ"}</td>
