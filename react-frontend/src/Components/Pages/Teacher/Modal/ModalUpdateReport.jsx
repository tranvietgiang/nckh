...
export default function ModalUpdateReport({ open, onClose, onSuccess, report }) {
    ...
    useEffect(() => {
        if (report && open) {
            ...
            setFormData({
                ...
                start_date: report.start_date ? formatDateForInput(report.start_date) : "",
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.put(`/teacher/reports/${report.id}`, {
            ...
            if (error.response?.status === 403) {
                alert("❌ Lỗi: Bạn không có quyền thực hiện thao tác này. Vui lòng đăng nhập lại với tài khoản giảng viên.");
                    ...
                    {user?.role !== 'teacher' && (
                        <div className="p-4 bg-red-50 border border-red-200 rounded-xl">
                            <p className="text-red-600 text-sm">
                                ⚠️ Cảnh báo: Tài khoản của bạn không phải là giảng viên.
                                Có thể bạn không có quyền cập nhật báo cáo.
                            </p>
                        </div>
                    )}
